 ...
 * ####配置:
 *
 * - [autoIndex](/docs/guide.html#autoIndex): bool - 默认值`null`（使用connection的autoIndex）
 * - [bufferCommands](/docs/guide.html#bufferCommands): bool - 默认值`true`
 * - [capped](/docs/guide.html#capped): bool - 默认值`false`
 * - [collection](/docs/guide.html#collection): string - 无默认值
 * - [id](/docs/guide.html#id): bool - 默认值`true`
 * - [_id](/docs/guide.html#_id): bool - 默认值`true`
 * - `minimize`: bool - controls 手动调用时，控制[document#toObject](#document_Document-toObject)`document#toObject`行为 - 默认值`true`
 * - [read](/docs/guide.html#read): string
 * - [safe](/docs/guide.html#safe): bool - 默认值`true`
 * - [shardKey](/docs/guide.html#shardKey): bool - 默认值`null`
 * - [strict](/docs/guide.html#strict): bool - 默认值`true`
 * - [toJSON](/docs/guide.html#toJSON) - object - 无默认值
 * - [toObject](/docs/guide.html#toObject) - object - 无默认值
 * - [typeKey](/docs/guide.html#typeKey) - string - 默认值`'type'`
 * - [useNestedStrict](/docs/guide.html#useNestedStrict) - boolean - 默认值`false`
 * - [validateBeforeSave](/docs/guide.html#validateBeforeSave) - bool - `defaults to ``true`
 * - [versionKey](/docs/guide.html#versionKey): string - 默认值`__v`
 * - [collation](/docs/guide.html#collation): object - 默认值`null` (意味着不使用合并)
 *
 * ####Note:
 *
 * _创建schema时（上例中的`children`），总会在传给它的父Schema前，进行声明child Schema。_
 *
 * @param {Object} 定义
 * @param {Object} [配置]
 * @继承自 NodeJS EventEmitter http://nodejs.org/api/events.html#events_class_events_eventemitter
 * @event `init`: 在Schema编译为`Model`触发事件。
 * @api public
 */
